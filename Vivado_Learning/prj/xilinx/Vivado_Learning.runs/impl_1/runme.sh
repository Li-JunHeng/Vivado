...
HD_PWD='D:/Vivado/Vivado_Learning/Vivado_Learning.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log course_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source course_1.tcl -notrace
