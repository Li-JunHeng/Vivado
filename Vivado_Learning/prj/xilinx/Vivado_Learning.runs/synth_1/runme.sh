...
HD_PWD='D:/Vivado/Vivado_Learning/Vivado_Learning.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log course_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source course_1.tcl
