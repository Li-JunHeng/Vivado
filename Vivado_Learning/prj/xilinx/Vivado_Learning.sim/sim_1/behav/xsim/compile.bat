...
REM
REM Generated by Vivado on Sun Sep 28 20:36:00 +0800 2025
...
echo "xvlog --incr --relax -prj tb_course_1_vlog.prj"
call xvlog  --incr --relax -prj tb_course_1_vlog.prj -log xvlog.log
